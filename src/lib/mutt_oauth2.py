...
# Almacenamiento de tokens en texto plano (con permisos 600).
# Para mayor seguridad se puede cambiar a GPG:
...
flow.  To truly start over from scratch, first delete TOKENFILE.
